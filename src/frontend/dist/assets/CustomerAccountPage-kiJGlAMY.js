import { c as createLucideIcon, f as useNavigate, r as reactExports, j as jsxRuntimeExports, B as Button, af as User, I as Input, L as Link, s as Package, a as ue } from "./index-Cy1OHAvE.js";
import { C as Card, b as CardHeader, c as CardTitle, a as CardContent } from "./card-DX8nNcXU.js";
import { L as Label } from "./label-D2N_xUJ0.js";
import { S as Separator } from "./separator-9NnVhImH.js";
import { getCustomerSession, clearCustomerSession } from "./CustomerLoginPage-OaCKS9Kr.js";
...
function CustomerAccountPage() {
  ...
  const [myOrders] = reactExports.useState(() => {
    try {
      const all = JSON.parse(
        localStorage.getItem("tkmart_orders") ?? "[]"
      );
      const phone2 = (session == null ? void 0 : session.phone) || "";
      const email = (session == null ? void 0 : session.email) || "";
      return all.filter(
        (o) => {
          var _a;
          return phone2 && ((_a = o.customerPhone) == null ? void 0 : _a.includes(phone2)) || email && o.customerEmail === email;
        }
      );
    } catch {
      return [];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-10", "data-ocid": "account.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { "data-ocid": "account.orders.card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: myOrders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Your placed orders will appear here." })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "account.orders.list", children: myOrders.map((order, i) => {
        var _a;
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: new Date(order.createdAt).toLocaleDateString("en-IN", {
                    day: "numeric",
                    month: "short",
                    year: "numeric"
                  }) })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-1", children: (_a = order.items) == null ? void 0 : _a.map((it) => `${it.name} x${it.quantity}`).join(", ") }),
              ...
              order.verifCode && order.status !== "delivered" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Delivery Code:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "font-mono font-bold text-sm",
                    style: { color: "oklch(0.78 0.14 85)" },
                    children: order.verifCode
                  }
                )
              ] })
            ]
