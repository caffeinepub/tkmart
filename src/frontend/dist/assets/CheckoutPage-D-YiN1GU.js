...
import { g as getSavedAddresses, M as MapPin } from "./CustomerAccountPage-kiJGlAMY.js";
import { L as LoaderCircle } from "./loader-circle-VPutQR0z.js";
import "./CustomerLoginPage-OaCKS9Kr.js";
import "./shopping-bag-CqBTPlHY.js";
import "./eye-md3BWRc0.js";
import "./log-out-DyxgSimO.js";
import "./plus-Dn0c_s3o.js";
import "./trash-2-X42nrFJ9.js";
import "./book-open-B0lmd6a4.js";
/**
...
function CheckoutPage() {
  ...
  function handlePlaceOrder() {
    ...
    if (!address.trim() || !form.phone.trim()) {
      ue.error("Please enter delivery address and phone number.");
      return;
    }
    setLoading(true);
    try {
      ...
      const customerName = form.name || (session == null ? void 0 : session.name) || "Customer";
      const order = {
        id: newOrderId,
        customerName,
        customerPhone: form.altPhone ? `${form.phone} / Alt: ${form.altPhone}` : form.phone,
        address,
        items,
