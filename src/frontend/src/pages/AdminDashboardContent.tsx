...
const DEFAULT_AI_SETTINGS: AISetting[] = [
  ...
  },
  {
    ...
    reply:
      "Standard delivery takes 3-5 business days. Our delivery person will ask for your 4-digit verification code on arrival.",
  },
  {
    id: "payment",
    topic: "Payment",
...
function saveAISettings(settings: AISetting[]) {
...
function loadAdminEBooks(): EBook[] {
  try {
...
export default function AdminDashboardContent() {
  ...
  // ── ebook state
  const [ebooks, setEbooks] = useState<EBook[]>(() => loadAdminEBooks());
  ...
  const [editingAI, setEditingAI] = useState<AISetting | null>(null);
  ...
  const handleCreateCategory = () => {
    ...
    const newCat: LocalCategory = { id: Date.now(), name, slug: toSlug(name) };
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <Tabs defaultValue="products" className="space-y-6">
          <TabsList className="grid w-full grid-cols-9 bg-card border border-border/50">
            <TabsTrigger
              value="products"
              className="gap-1.5"
          ...
          <TabsContent value="ebooks" className="space-y-4">
            ...
            {ebooks.length === 0 ? (
              <Card data-ocid="admin.ebooks.empty_state">
                <CardContent className="py-12 text-center text-muted-foreground">
                  No e-books yet.
                </CardContent>
              </Card>
                    ...
                    >
                      ...
                      <CardContent className="p-3">
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">
                          {salesCount} purchase{salesCount !== 1 ? "s" : ""}
                        </p>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setEbookForm((p) => ({ ...p, title: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setEbookForm((p) => ({ ...p, author: e.target.value }))
                      }
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setEbookForm((p) => ({ ...p, price: e.target.value }))
                        }
                        placeholder="99"
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setEbookForm((p) => ({ ...p, pages: e.target.value }))
                        }
                        placeholder="100"
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setEbookForm((p) => ({ ...p, content: e.target.value }))
                      }
                      rows={4}
          ...
          <TabsContent value="ai" className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">
                  Add Q&amp;A entries that TK Assistant uses to answer customer
                  questions instantly. Changes apply live — no restart needed.
                </p>
              </div>
              <Button
              ...
              <Card>
                <CardContent className="py-3 px-4 text-center">
                  <div className="text-2xl font-bold text-green-500">
                    {aiSettings.filter((s) => s.keywords).length}
                  </div>
                  <div className="text-xs text-muted-foreground">
                    Active Topics
                  </div>
            ...
            <div className="space-y-3">
              ...
              {aiSettings.length === 0 && (
                <Card data-ocid="admin.ai.empty_state">
                  <CardContent className="py-12 text-center text-muted-foreground">
                    No knowledge base entries yet. Click "Add Entry" to get
                    started.
                  </CardContent>
                </Card>
              )}
            ...
            <Dialog open={aiDialogOpen} onOpenChange={setAiDialogOpen}>
              <DialogContent data-ocid="admin.ai.dialog" className="max-w-lg">
                <DialogHeader>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        value={aiForm.topic}
                        onChange={(e) =>
                          setAiForm((f) => ({ ...f, topic: e.target.value }))
                        }
                      />
                    </div>
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setAiForm((f) => ({ ...f, keywords: e.target.value }))
                        }
                      />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setAiForm((f) => ({ ...f, question: e.target.value }))
                      }
                    />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <Textarea
                      ...
                      value={aiForm.reply}
                      onChange={(e) =>
                        setAiForm((f) => ({ ...f, reply: e.target.value }))
                      }
                    />
                    <p className="text-xs text-muted-foreground">
                      Leave Keywords empty to set this as the default reply when
                      no topic matches.
                    </p>
                  </div>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (!aiForm.topic.trim() || !aiForm.reply.trim()) {
                          toast.error("Topic and answer are required.");
                          return;
                        }
                        let updated: AISetting[];
                        if (editingAI) {
                          updated = aiSettings.map((s) =>
                            s.id === editingAI.id
                              ? {
                                  ...s,
